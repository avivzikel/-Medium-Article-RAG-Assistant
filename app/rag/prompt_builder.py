SYSTEM_PROMPT = (
    ...
    'retrieved context. If the answer cannot be determined from the provided context, respond: “I don’t '
    'know based on the provided Medium articles data.”\n'
    'Always explain your answer using the given context, quoting or paraphrasing the relevant article '
    'passage or metadata when helpful.'
)
